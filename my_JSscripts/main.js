            ...
            .on('renderlet', function (table) {
                ...
                _.each(allDim.top(Infinity), function (d) {
                    ...
                    marker.bindPopup(
                        ...
                        + "<dt> Alkalinity 2: " + d.properties.Alkalini_1 + ";<dd>" 
                        ...
                        + "<dt> Conductivity: " + d.properties.Conductivi + ";<dd>" 
                        + "<dt> Cr: " + d.properties.Cr + ";<dd>" 
                        + "<dt> DO: " + d.properties.DO + ";<dd>" 
                        + "<dt> Electrical: " + d.properties.Electrical + ";<dd>" 
                        + "<dt> Gross Alpha 1: " + d.properties.Gross_alph + ";<dd>" 
                        + "<dt> Gross Aplha 2: " + d.properties.GrossAplha + ";<dd>" 
                        + "<dt> Gross Beta 1: " + d.properties.GrossBeta + ";<dd>" 
                        + "<dt> Gross Beta 2: " + d.properties.GrossBeta_ + ";<dd>" 
                        + "<dt> Hardness: " + d.properties.Hardness + ";<dd>" 
                        + "<dt> Total Hardness: " + d.properties.Hardness_T + ";<dd>" 
                        ...
                        + "<dt> Na Fraction: " + d.properties.Na_Fractio + ";<dd>" 
                        + "<dt> Na_K: " + d.properties.Na_K + ";<dd>" 
                        + "<dt> Nitrate: " + d.properties.Nitrate + ";<dd>" 
                        + "<dt> Nitrate_Ni: " + d.properties.Nitrate_Ni + ";<dd>" 
                        ...
                        + "<dt> Temperature: " + d.properties.Temperatur + ";<dd>" 
