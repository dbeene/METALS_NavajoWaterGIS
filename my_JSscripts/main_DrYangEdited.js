...
window.onload = function () {
    ...
    // define the update Scatterplot matrix function //Dr Yang addded
    // function graphicviz() {
    // function updateScatterplotMatrix() { //Dr Yang added //Dr. Yang renamed daniel's old function "graphicviz" to "updateScatterplotMatrix"
    // define a gloabl function, so the update Plot button can trigger this function.
    // FYI, see here for example of how to define and call a global function: https://subinsb.com/global-functions-javascript/
    window.updateScatterplotMatrix = function() { //Dr Yang added 
        //Dr. Yang renamed daniel's old function "graphicviz" to "updateScatterplotMatrix" and defined it as a global function, so we can call this function when user click the update plot button
        require.config({
            paths: {
    ...
    // graphicviz();
    updateScatterplotMatrix(); //Dr Yang added
